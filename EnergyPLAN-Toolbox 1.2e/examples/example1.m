...
[annualData, monthlyData, hourlyData,CO2, PES, RESshare,...
 TotalAnnualCosts, VariableCosts,Coal, Oil, Ngas,...
 Biomass, Nuclear]=energyPlan(energyPlanPath, inputFilePath, outputFolder,...
